...
function IstanbulGuide() {
  ...
  </ScrollView><IstanbulPlaceModal place={selectedPlace} onClose={() => setSelectedPlace(null)} /><IstanbulDistrictModal district={selectedDistrict} onClose={() => setSelectedDistrict(null)} /></SafeAreaView>;
}

function IstanbulPlaceModal({ place, onClose }: { place: IstanbulPlace | null; onClose: () => void }) {
