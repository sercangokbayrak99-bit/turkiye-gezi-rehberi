...
import { istanbulAccommodations, istanbulDistricts, istanbulFoodGuide, istanbulPlaces, istanbulRoutes, istanbulTransport, istanbulVenueAreas, type IstanbulDistrict, type IstanbulPlace } from './src/istanbulData';
...
export default function App() {
  ...
  const content = tab === 'plan'
    ...
    : tab === 'profile'
      ...
      : activeCity === 'istanbul'
        ? <IstanbulGuide plannedPlaceIds={plannedIstanbulPlaces} onTogglePlan={toggleIstanbulPlacePlan} />
      : <MainContent
          exploreOnly={false}
          query={query}
          setQuery={setQuery}
...
function IstanbulGuide({ plannedPlaceIds, onTogglePlan }: { plannedPlaceIds: string[]; onTogglePlan: (id: string) => void }) {
  const [query, setQuery] = useState('');
