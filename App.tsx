...
export default function App() {
  ...
  const favoritePlaces = [...allBursaPlaces, ...bursaBaths, ...istanbulFavoritePlaces, ...istanbulBeachFavoritePlaces].filter(place => favorites.includes(place.id));
