...
export const izmirPlaces: IzmirPlace[] = [
  { id: 'izmir-saat-kulesi', name: 'İzmir Saat Kulesi ve Konak Meydanı', district: 'Konak', category: 'Tarihî yapı', summary: '1901 tarihli Saat Kulesi, Hükûmet Konağı ve körfez kıyısıyla İzmir’in en tanınabilir kent odağı.', image: require('../assets/izmir/hero.jpg'), mapQuery: 'İzmir Saat Kulesi Konak İzmir', credit: 'AnisKoutsi · CC BY-SA 4.0', imagePage: commons('Konak_Saat_Kulesi,_Izmir.jpg'), sourceUrl: tourism },
  { id: 'izmir-kemeralti', name: 'Kemeraltı Çarşısı ve Kızlarağası Hanı', district: 'Konak', category: 'Tarihî doku', summary: 'Hanları, ibadet yapıları, dükkânları ve geleneksel yeme-içme duraklarıyla yaşayan tarihî çarşı rotası.', image: require('../assets/izmir/kemeralti.jpg'), mapQuery: 'Kızlarağası Hanı Kemeraltı Konak İzmir', credit: 'Dosseman · CC BY-SA 4.0', imagePage: commons('Izmir_Kemeraltı_Çarşısı_5899.jpg'), sourceUrl: tourism },
  ...
  { id: 'izmir-ekmeksiz', name: 'Ekmeksiz Plajı', district: 'Seferihisar', category: 'Sahil', summary: 'Teos ve Sığacık yakınındaki doğal kıyı; erişim ve işletme durumu mevsimsel olarak resmî kaynaklardan kontrol edilmelidir.', image: require('../assets/izmir/ekmeksiz.jpg'), mapQuery: 'Ekmeksiz Plajı Seferihisar İzmir', credit: 'Fivitria · CC BY-SA 4.0', imagePage: commons('Branches_of_a_tree_in_Ekmeksiz_beach.jpg'), sourceUrl: 'https://seferihisar.bel.tr/' },
