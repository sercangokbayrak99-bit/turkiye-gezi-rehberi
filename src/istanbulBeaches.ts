...
const beachPhotos: Record<string, { image: ImageSourcePropType; credit: string; page: string }> = {
  ...
  'gunes-plaji': { image: require('../assets/istanbul/beaches/florya-sunset.jpg'), credit: '07 · CC BY-SA 4.0', page: 'https://commons.wikimedia.org/wiki/File:Sunset_from_Florya,_Istanbul.jpg' },
  ...
  'buyukcekmece-cocuk': { image: require('../assets/istanbul/beaches/buyukcekmece.jpg'), credit: 'buzkozan · CC BY 3.0', page: 'https://commons.wikimedia.org/wiki/File:B%C3%BCy%C3%BCk%C3%A7ekmece_Plaj%C4%B1_Panoramas%C4%B1,_May%C4%B1s_2014_-_panoramio.jpg' },
