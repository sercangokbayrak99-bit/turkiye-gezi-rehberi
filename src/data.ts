...
export const spiritualSites: SpiritualSite[] = [
  { id: 'osman-gazi', city: 'Bursa', name: 'Osman Gazi Türbesi', district: 'Osmangazi', kind: 'Türbe', period: 'Osmanlı’nın kuruluş dönemi', summary: 'Osmanlı Devleti’nin kurucusu Osman Gazi’nin Tophane’de bulunan türbesi; bugünkü yapı 1863 yılında yeniden yaptırılmıştır.', etiquette: 'Sessizliği koruyun, sandukalara dokunmayın ve ibadet eden ziyaretçilere alan bırakın.', image: require('../assets/spiritual/osman-gazi.jpg'), imageCredit: 'Dosseman · CC BY-SA 4.0', imagePage: 'https://commons.wikimedia.org/wiki/File:Bursa_Osman_Gazi_T%C3%BCrbesi_2014_0051.jpg', mapQuery: 'Osman Gazi Türbesi Bursa', sourceUrl: 'https://www.kulturportali.gov.tr/turkiye/bursa/gezilecekyer/osmangazi-turbesi' },
  { id: 'orhan-gazi', city: 'Bursa', name: 'Orhan Gazi Türbesi', district: 'Osmangazi', kind: 'Türbe', period: '14. yüzyıl Osmanlı mirası', summary: 'Bursa Fatihi Orhan Gazi’ye ait türbe, Tophane Parkı’nda Osman Gazi Türbesi’nin karşısında yer alır.', etiquette: 'Ziyaret sırasında sakin olun; içeride fotoğraf kuralları ve görevli yönlendirmelerine uyun.', image: require('../assets/spiritual/orhan-gazi.jpg'), imageCredit: 'Dosseman · CC BY-SA 4.0', imagePage: 'https://commons.wikimedia.org/wiki/File:Orhan_Gazi_T%C3%BCrbesi_6894.jpg', mapQuery: 'Orhan Gazi Türbesi Bursa', sourceUrl: 'https://kulturportali.gov.tr/turkiye/bursa/kulturenvanteri/orhan-gazi-turbesi' },
  ...
  { id: 'geyikli-baba', city: 'Bursa', name: 'Geyikli Baba Türbesi', district: 'Kestel', kind: 'Türbe', period: 'Erken Osmanlı dönemi', summary: 'Babasultan yerleşiminde bulunan türbe, Bursa’nın kuruluş dönemi manevi şahsiyetlerinden Geyikli Baba’yla ilişkilidir.', etiquette: 'Köy yaşamına ve ziyaret alanının yerel düzenine saygı gösterin.', image: require('../assets/spiritual/geyikli-baba.jpg'), imageCredit: 'İsosfer · CC BY-SA 4.0', imagePage: 'https://commons.wikimedia.org/wiki/File:Geyikli_Baba_T%C3%BCrbesi_1.jpg', mapQuery: 'Geyikli Baba Türbesi Babasultan Bursa', sourceUrl: 'https://bursa.ktb.gov.tr/TR-70228/bursa-ili-genel-bilgiler.html' },
  { id: 'hudavendigar', city: 'Bursa', name: 'I. Murad Hüdavendigâr Türbesi', district: 'Osmangazi', kind: 'Türbe', period: '14. yüzyıl', summary: 'Çekirge’deki Hüdavendigâr Külliyesi içinde, Osmanlı hükümdarı I. Murad’a ait türbedir.', etiquette: 'Cami ve türbe bölümlerini ayıran yönlendirmelere, kıyafet ve sessizlik kurallarına uyun.', image: require('../assets/spiritual/hudavendigar.jpg'), imageCredit: 'Dosseman · CC BY-SA 4.0', imagePage: 'https://commons.wikimedia.org/wiki/File:H%C3%BCdavendigar_T%C3%BCrbesi_7574.jpg', mapQuery: 'Hüdavendigar Türbesi Bursa', sourceUrl: 'https://bursa.ktb.gov.tr/Eklenti/78710%2Cdergi1-turkcepdf.pdf?0=' },
