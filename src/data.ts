...
export const bursa: City = {
  ...
  places: [
    ...
    { id: 'bursa-arkeoloji-muzesi', name: 'Bursa Arkeoloji Müzesi', district: 'Osmangazi · Çekirge', category: 'Tarih', summary: 'Bitinya ve Misya’dan tarih öncesi dönemlere, Roma ve Bizans eserlerine uzanan zengin arkeoloji koleksiyonu.', image: require('../assets/bursa/arkeoloji-muzesi.jpg'), mapQuery: 'Bursa Arkeoloji Müzesi Çekirge', imageCredit: 'Canercangul · CC BY-SA 4.0', imagePage: 'https://commons.wikimedia.org/wiki/File:Bursa_Arkeoloji_M%C3%BCzesi_(3).jpg' },
    { id: 'tofas-anadolu-arabalari', name: 'Tofaş Anadolu Arabaları Müzesi', district: 'Yıldırım', category: 'Tarih', summary: 'Anadolu’daki tekerlek ve taşıt kültürünü geleneksel arabalardan otomotiv tarihine uzanan sergilerle anlatan aile dostu müze.', image: require('../assets/bursa/tofas-muzesi.jpg'), mapQuery: 'Tofaş Anadolu Arabaları Müzesi Bursa', imageCredit: 'Hbasak · Kamu malı', imagePage: 'https://commons.wikimedia.org/wiki/File:TofasMuze2.JPG' },
