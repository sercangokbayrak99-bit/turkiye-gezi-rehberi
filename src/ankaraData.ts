...
export const ankaraPlaces: AnkaraPlace[] = [
  { id: 'ankara-anitkabir', name: 'Anıtkabir', district: 'Çankaya', category: 'Tarihî yapı', summary: 'Mustafa Kemal Atatürk’ün mozolesi, Kurtuluş Savaşı Müzesi, Aslanlı Yol ve tören meydanıyla başkentin en önemli ziyaret alanı.', image: require('../assets/ankara/anitkabir.jpg'), mapQuery: 'Anıtkabir Çankaya Ankara', credit: 'Diego Delso · CC BY-SA 4.0', imagePage: 'https://commons.wikimedia.org/wiki/File:Anıtkabir,_Ankara,_Turquía,_2024-10-03,_DD_27.jpg', sourceUrl: 'https://www.anitkabir.tsk.tr/' },
  ...
  { id: 'ankara-anadolu-medeniyetleri', name: 'Anadolu Medeniyetleri Müzesi', district: 'Altındağ', category: 'Müze', summary: 'Paleolitik Çağ’dan Osmanlı dönemine uzanan Anadolu arkeolojisini, Mahmut Paşa Bedesteni ve Kurşunlu Han’da kronolojik olarak anlatır.', image: require('../assets/ankara/anadolu-medeniyetleri.jpg'), mapQuery: 'Anadolu Medeniyetleri Müzesi Altındağ Ankara', credit: 'Carole Raddato · CC BY-SA 2.0', imagePage: 'https://commons.wikimedia.org/wiki/File:Museum_of_Anatolian_Civilizations,_Ankara_(31093737884).jpg', sourceUrl: 'https://muze.gov.tr/muze-detay?DistId=AMM&SectionId=AMM01' },
  { id: 'ankara-hamamonu', name: 'Hamamönü', district: 'Altındağ', category: 'Tarihî doku', summary: 'Restore edilmiş Ankara evleri, Mehmet Âkif Ersoy Müze Evi, el sanatları ve yeme-içme duraklarıyla yürüyerek keşfedilen tarihî mahalle.', image: require('../assets/ankara/hamamonu.jpg'), mapQuery: 'Hamamönü Altındağ Ankara', credit: 'Bjørn Christian Tørrissen · CC BY-SA 2.0', imagePage: 'https://commons.wikimedia.org/wiki/File:Hamamönü_(9663854025).jpg', sourceUrl: 'https://kulturportali.gov.tr/turkiye/ankara/gezilecekyer/hamamonu' },
  ...
  { id: 'ankara-atakule', name: 'Atakule', district: 'Çankaya', category: 'Manzara', summary: 'Çankaya sırtlarında yer alan seyir kulesi; şehir panoraması, alışveriş ve yeme-içme alanlarıyla modern Ankara’nın simgelerinden.', image: require('../assets/ankara/atakule.jpg'), mapQuery: 'Atakule Çankaya Ankara', credit: 'A. Savin · FAL', imagePage: 'https://commons.wikimedia.org/wiki/File:Ankara_asv2021-10_img10_Atakule.jpg', sourceUrl: 'https://www.kulturportali.gov.tr/turkiye/ankara/gezilecekyer/atakule' },
  ...
  { id: 'ankara-gordion', name: 'Gordion Antik Kenti ve Müzesi', district: 'Polatlı', category: 'Tarihî yapı', summary: 'Frigya’nın başkenti, Büyük Tümülüs ve arkeoloji müzesiyle birlikte 2023’ten beri UNESCO Dünya Mirası Listesi’nde.', image: require('../assets/ankara/gordion.jpg'), mapQuery: 'Gordion Antik Kenti Yassıhöyük Polatlı Ankara', credit: 'Dosseman · CC BY-SA 4.0', imagePage: 'https://commons.wikimedia.org/wiki/File:Gordion_Museum,_Turkey_01.jpg', sourceUrl: 'https://www.kulturportali.gov.tr/portal/gordion' },
  { id: 'ankara-beypazari', name: 'Beypazarı Tarihî Merkezi', district: 'Beypazarı', category: 'Tarihî doku', summary: 'Cumbalı evleri, yaşayan müzeleri, el sanatları, çarşısı ve yerel mutfağıyla Ankara’nın en kapsamlı günübirlik kültür rotalarından.', image: require('../assets/ankara/beypazari.jpg'), mapQuery: 'Beypazarı tarihi evleri Ankara', credit: 'Wikimedia Commons', imagePage: 'https://commons.wikimedia.org/wiki/File:Beypazari_(2).jpg', sourceUrl: 'https://kulturportali.gov.tr/turkiye/ankara/gezilecekyer/beypazari-yasayan-muze' },
  ...
  { id: 'ankara-altinpark', name: 'Altınpark', district: 'Altındağ', category: 'Aile & Park', summary: 'Gölet, bahçeler, spor ve etkinlik alanlarıyla geniş bir kent parkı; Feza Gürsey Bilim Merkezi sayesinde çocuklu aileler için de uygun.', image: require('../assets/ankara/altinpark.jpg'), mapQuery: 'Altınpark Altındağ Ankara', credit: 'Wikimedia Commons', imagePage: 'https://commons.wikimedia.org/wiki/File:Ankara_Altınpark_2014.jpg', sourceUrl: 'https://kulturportali.gov.tr/turkiye/ankara/gezilecekyer/altinpark' },
];
